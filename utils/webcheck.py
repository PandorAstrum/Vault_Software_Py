...
__desc__ = "Checking website and return the technology used"
"""
import six
import sys
import os
...
def load_apps(file_name='app.json.py'):
    ...
    _file_name = os.path.join(DLL_ROOT, file_name)
    return json.load(open(_file_name))
