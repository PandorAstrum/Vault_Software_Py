...
__desc__ = "This module contains configuration functions."
...
def _setup_locale():
    ...
    """
    try:
        locale_file = Config.get('translator', 'locale_file')
    except:
        from os.path import abspath, dirname, join
        locale_file = join(dirname(abspath(__file__)), 'english.mo')
