    ...
    BoxLayout:
            ...
            MDCard:
                ...
                BoxLayout: # link parameter Multipage
                    ...
                    MDLabel:
                        ...
                        width: self.width
                        text: "Multipage"
                        theme_text_color: "Primary" if multipage_id.active else "Secondary"
                    MDTextField:
                        hint_text: "Next Button Xpath" if multipage_id.active else "Disabled"
                        color_mode: "accent"
                        disabled: False if multipage_id.active else True
        ...
        BoxLayout: # Field box
            ...
            MDCard:
                ...
                BoxLayout: # scrap helper buttons
                    size_hint: None, None
                    height: self.minimum_height
                    width: self.minimum_width
                    pos_hint: {"center_x": 0.5, "center_y": 0.5}
...
"""
kv = mining_scrapy_tab_kv + mining_selenium_tab_kv + mining_help_tab
